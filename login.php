...
if(isset($_POST['submit'])){
	...
	if(mysqli_num_rows($query)==1){
		...
		$_SESSION['login_name']['firstname']= $name;
  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				...
  				<h2 class="text-gradient-primary"><b>Music Player</b></h2>
  				</span>
  			</div>
  				...
  				<div class="card-body">
  					<!-- <form id="login-form" > -->
						<form method="post"name="myform"onsubmit="return validate()" >
  						...
  						<center><button class="btn btn-block btn-wave btn-primary bg-gradient-primary" name="submit">Login</button></center>
  						<hr>
