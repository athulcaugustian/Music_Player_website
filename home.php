          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-primary">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php echo $conn->query("SELECT * FROM uploads where user_id ={$_SESSION['users']['id']} ")->num_rows; ?>
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-primary">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php echo $conn->query("SELECT * FROM playlist where user_id ={$_SESSION['users']['id']}")->num_rows; ?>
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
